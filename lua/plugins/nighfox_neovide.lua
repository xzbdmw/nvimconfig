    ...
    config = function()
        ...
        local groups = {
            dawnfox = {
                ...
                MiniSnippetsVisited = { fg = "#ff0000", sp = "none" },
                MiniSnippetsFinal = { fg = "none" },
                ...
                TelescopeGrepMatching = { style = "underline,bold,nocombine", sp = "#A4A3A3" },
            ...
            dayfox = {
                ...
                BlinkCmpLabelMatch = { fg = "none", style = "bold" },
                BlinkCmpMenuSelection = { link = "MyCursorLine" },
