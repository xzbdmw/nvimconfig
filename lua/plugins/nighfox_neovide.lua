    ...
    config = function()
        ...
        local groups = {
            dawnfox = {
                ...
                IncSearchBlue = { fg = "none", bg = "#C9D2F5" },
                SearchBlue = { fg = "none", bg = "#C2D7DE" },
                illuminatedWordKeepText = { link = "SearchBlue" },
                illuminatedWordKeepRead = { link = "SearchBlue" },
                illuminatedWordKeepWrite = { link = "IncSearchBlue" },
                ...
                ["@constant"] = { link = "@lsp.type.property" },
