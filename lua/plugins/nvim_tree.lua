...
local function my_on_attach(bufnr)
    ...
    keymap("n", "y", "y", opts("return to origin buffer"))
    keymap("n", "<leader>cF", api.fs.copy.absolute_path, opts("return to origin buffer"))
    keymap("n", "p", api.node.navigate.parent, opts("return to origin buffer"))
    keymap("n", "l", api.node.open.edit, opts("open file/expand directory"))
    keymap("n", "h", api.node.navigate.parent, opts("go to parent directory"))
