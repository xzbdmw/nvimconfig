local log = require("custom.definition-or-references.util.debug")
local methods = require("custom.definition-or-references.methods_state")
local util = require("custom.definition-or-references.utils")
...
local function definitions()
    ...
    print(vim.inspect(util.make_params()))
    vim.lsp.buf_request(0, methods.definitions.name, util.make_params(), function(err, result, context, _)
